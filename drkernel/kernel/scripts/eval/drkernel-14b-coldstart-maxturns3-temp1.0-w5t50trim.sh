...
RUN_NAME="drkernel-14b-coldstart-maxturns3-temp1.0-w5t50trim"
...
# Timing config: 5 warmup + 50 trials, trim 5 from each end
NUM_PERF_TRIALS=50
NUM_WARMUP=5
PERF_TRIM_COUNT=5
...
echo "=========================================="
echo "Coldstart Config B: 5 warmup + 50 trials, trim 20%"
echo "=========================================="
