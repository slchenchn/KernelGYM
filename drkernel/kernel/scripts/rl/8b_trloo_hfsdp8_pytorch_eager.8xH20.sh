...
# 8× H20 (1 node), 16× 4090 reward workers reached through the local relay
# FSDP-8 on a single node, SP=4
...
TRAIN_LOG_HW="${TRAIN_LOG_HW:-8xH20}"
...
# Data
# =============================================================================
TRAIN_DATASET=("data/drkernel-rl-data/cuda_llm_rl_thinking_1025.parquet")
VALID_DATASET=("data/drkernel-validation-data/validation_data_thinking.parquet")
...
# Reward config
# =============================================================================
KERNELGYM_SERVER_URL="${KERNELGYM_SERVER_URL:-http://127.0.0.1:18111}"
...
PPO_MICRO_TOKEN="${PPO_MICRO_TOKEN:-16384}"
...
# Resolve relative data paths from drkernel/ regardless of the caller's cwd.
enter_drkernel_root
