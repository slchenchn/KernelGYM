...
MODEL_NAME="${MODEL_NAME:-hkust-nlp/drkernel-8b}"
MODEL_PATH="${MODEL_PATH:-${MODEL_NAME}}"

RUN_NAME="${RUN_NAME:-drkernel-8b-trloo-2node}"
...
PPO_MICRO_TOKEN="${PPO_MICRO_TOKEN:-24576}"
